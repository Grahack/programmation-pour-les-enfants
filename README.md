...
### MicroAlg
Langage de programmation simple en français, dédié à l’algorithmique et à son enseignement. Il est généraliste (pas de robot à piloter), exécutable sur une page Web et peut être utilisé soit en manipulant des blocs grâce à [Blockly](#blockly) soit en tapant du code sous forme textuelle. http://microalg.info/
